package honhatquang890.gmail.com.lab2;
...
public class SecurityConfig {
    ...
    public SecurityFilterChain securityFilterChain(@NotNull HttpSecurity http) throws Exception {
        return http.authorizeHttpRequests(auth -> auth.requestMatchers("/css/**", "/js/**", "/", "/oauth/**", "/register", "/error",
...
//                                .requestMatchers("order/orderdetail")
//                                .hasAnyAuthority("USER")// Chỉ cho phép USER truy cập.
                                .requestMatchers("/api/**")
